...
<table>
    ...
    <tbody>
        <?php
        $teste1 = listarTabela("id, nome, cadastro, alteracao, ativo", 'teste1', 'id');
        ...
        ?>
                <tr>
                    ...
                    <td class="text-center">
                        <form action="excluirTeste1.php" method="post">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="editarTeste1.php" method="post">
...
<div class="modal fade" id="cadastrarModal" tabindex="-1" role="dialog" aria-labelledby="cadastrarModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="inserirTeste1.php" method="post">
