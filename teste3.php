...
<table>
    ...
    <tbody>
        <?php
        $teste3 = listarTabela("id, nome, cadastro, alteracao, ativo", 'teste3', 'id');
        foreach ($teste3 as $row) {
        ...
        ?>
                <tr>
                    ...
                    <td class="text-center">
                        <form action="excluirTeste3.php" method="post">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="editarTeste3.php" method="post">
...
<div class="modal fade" id="cadastrarModal" tabindex="-1" role="dialog" aria-labelledby="cadastrarModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="inserirTeste3.php" method="post">
